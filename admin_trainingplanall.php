    ...
    <section id="book-a-table" class="book-a-table">
      <div class="container" data-aos="fade-up">
        ...
        <form action="forms/book-a-table.php" method="post" role="form" class="php-email-form" data-aos="fade-up" data-aos-delay="100">
          <!-- <a href="admin_addtrainingplan.php">New</a> -->
          ...
          <table  align="center" width="100%">
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td><a href="admin_edittrainingplan.php?id=<?php echo $idd; ?>">Edit</a></td>
                                        <td><a href="admin_deltrainigplan.php?id=<?php echo $idd; ?>">Delete</a></td>
                                    </tr>
                            <?php
                                }
                            ?>  
                        ...
                        <p> </p>
                        <center>  <a href="admin_addtrainingplan.php"><button class="button"type="button">ADD</button></a></center>
