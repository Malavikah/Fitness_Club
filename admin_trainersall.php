    ...
    <section id="book-a-table" class="book-a-table">
      <div class="container" data-aos="fade-up">
        ...
        <form action="forms/book-a-table.php" method="post" role="form" class="php-email-form" data-aos="fade-up" data-aos-delay="100">
          <a href="admin_edittrainer.php"></a>
          ...
          <table  align="center" width="100%">
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td><a href="admin_edittrainer.php?id=<?php echo $row['tid']; ?>">Edit</a></td>     
                                        <td><a href="admin_deltrainer.php?id=<?php echo $row['tid']; ?>">Delete</a></td>       
                                       <!-- <?php $idd=$row['pid']; ?>  -->
<!-- 
                                        <td><a href="admin_addtrainingplan.php?id=<?php echo $idd; ?>">Edit</a></td>
                                        <td><a href="admin_addtrainigplandel.php?id=<?php echo $idd; ?>">Delete</a></td>  -->
                                    </tr>
                            <?php
                                }
                            ?>
                       ...
                       <center>  <a href="admin_addtrainer.php"><button class="button"type="button">ADD</button></a></center>
            <!-- <tr>
              <td>phone</td>
