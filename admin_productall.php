    ...
    <section id="book-a-table" class="book-a-table">
      <div class="container" data-aos="fade-up">
        ...
        <form action="forms/book-a-table.php" method="post" role="form" class="php-email-form" data-aos="fade-up" data-aos-delay="100">
          <a href="admin_editproduct.php"></a>
          ...
          <table  align="center" width="100%">
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td><img width="200" height="100" src="<?php echo $row['image']; ?>">
                                        </td>   
                                        <?php $idd=$row['prid']; ?>

                                        <td><a href="admin_editproduct.php?id=<?php echo $idd; ?>">Edit</a></td>
                                        <td><a href="admin_delproduct.php?id=<?php echo $idd; ?>">Delete</a></td>
                                    </tr>
                            <?php
                                }
                            ?>
                        ...
                        <br>
                         ...
                         <center>  <a href="admin_addproduct.php"><button class="button"type="button">ADD</button></a></center>
