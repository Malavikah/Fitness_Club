...
include('dbconnections.php');
    ...
    $sql="select a.*,b.name as pname,c.name as uname from prod_purchase as a,user as b,product as c where a.uid=b.ui and a.prid=c.prid";
          ...
          <table  align="center" width="100%">
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td><img width="200" height="100" src="<?php echo $row['screen']; ?>">
                                        </td>   
                                       <!--  <?php $idd=$row['pid']; ?>
