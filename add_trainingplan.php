...
if(isset($_POST['submit']))
{
    ...
    {
        $target_file= $_FILES["file1"]["name"][$i];
        $sql="INSERT INTO `trainigplan` (`file`) VALUES ('$target_file')";
        ...
        else
        {
         ...
         move_uploaded_file($_FILES["file1"]["tmp_name"][$i], "uploads/".$target_file)
    // }
// }
?>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <form method="post" role="form" enctype="multipart/form-data"  data-aos="fade-up" data-aos-delay="100">
                        ...
                        <tr>
                            ...
                            <tr>
                                <td>Exercise Plan</td>
                                <td> <textarea rows="2" cols="20" name="plan" ></textarea></td>

                                <!-- <td><input type="text" required name="plan" ></td> -->
                            <!-- </tr>
                            <tr>
                                <td>Food Plan</td>
                                <td><input type="text" required name="food"></td>
                            </tr>
                           
                            <tr> --> 
                                <!-- <td>Videos</td>
                                <td>   -->
                                    <input type="file" required name="file1[]" multiple>
                                <!-- </td> -->
                            <!-- </tr>
                            <tr>
                                <td></td> -->
