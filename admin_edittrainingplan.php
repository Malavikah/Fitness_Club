  ...
  <main id="main">
    ...
    <section id="book-a-table" class="book-a-table">
      <div class="container" data-aos="fade-up">
        ...
        <br>
        <br>
        <p align="Center">UPDATE TRAINING PLAN</p>
        <form method="post" role="form" enctype="multipart/form-data"  data-aos="fade-up" data-aos-delay="100">
                        ...
                        <tr>
                            ...
                            <tr>
                                ...
                                <td> <textarea rows="2" cols="30" required name="plan" value="<?php echo $plan ?>"></textarea></td>
                             <!-- <input type="text" required name="plan" value="<?php echo $plan ?>" ></td> -->
                            </tr>
                            <tr>
                                <td>Food Plan</td>
                                <td> <textarea rows="2" cols="30" name="food" value="<?php echo $food ?>"></textarea></td>
                                <!-- <td><input type="text" required name="food" value="<?php echo $food ?>" ></td> -->
                            </tr>
                            <!-- <tr>
                                <td>Time</td>
                                <td><input type="text" required name="time" value="<?php echo $target_file ?>" ></td>
                            </tr> -->
                            <tr>
                                <td>Video</td>
                                <td><input type="file"  name="file1" value="<?php echo $target_file ?>"></td>
                            </tr>
                            <tr>
                                <td></td>
