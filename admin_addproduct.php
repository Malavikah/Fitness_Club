...
if(isset($_POST['submit']))
  {
    ...
    // else
    // {
       $sql="INSERT INTO `product` (`type`, `name`, `price`, `image`, `descr`, `expdate`, `qty`) VALUES ('$type', '$name', '$price','$target_file', '$des', '$exp', '$qty')";
    // }
      // echo $sql;
...
<title>FITNESS CLUB</title>
  ...
  <link href="assets\img\icon.jpg" rel="aassets\img\icon.jpg">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <form method="post" role="form"  enctype="multipart/form-data" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <table align="center">
                            ...
                            <tr>
                                <td>Description</td>
                                <td><input type="text" required name="descr"></td>
                            </tr>
                             <tr>
                                <td>Exp Date</td>
                                <td><input type="text" required name="expdate" ></td>
                            </tr>
                             <tr>
                                <td>Quantity</td>
